...
sampleCols <- c("biologicalSampleName", "C4_Cell_Line_ID", 
                ...
                "DateRNAHarvested", "RNAHarvestedNotes", 
                "PassageAtHarvest", "DatemRNAExtracted", "DatemRNAExtractedNotes",
...
sampleProcessMetadata <- filter(sampleProcessMetadata, tolower(DateRNASubmittedtoCore) != "n/a")
